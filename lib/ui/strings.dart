...
class HomeStrings {
  ...
  final String protectionOn = 'Защита активна — фильтр работает.';
...
class ModeStrings {
  ...
  final String standardSummary =
      'Адаптивная фильтрация — реклама и трекинг урезаны, сайты работают стабильно.';
  final String strictSummary =
      'Усиленная фильтрация — блокируется больше рекламных и трекерных доменов. Возможны редкие поломки.';
  final String ultraSummary =
      'Агрессивная фильтрация — возможны поломки приложений и сайтов.';
}
...
class ProtectionInfoStrings {
  ...
  final String intro =
      'StillNet — локальный фильтр на устройстве, который глушит цифровой шум: рекламу, навязчивые трекеры и подозрительные запросы. Интернет остаётся быстрым, а внимание — сфокусированным.';
